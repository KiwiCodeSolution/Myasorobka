        ...
        <div className="flex flex-col gap-y-6">
          <div className="bg-bg-orange max-w-[420px] rounded-3xl md:absolute top-[176px] left-[10px] md:left-[120px] py-3 px-5">
            ...
            <p className="font-medium">
              ...
              власний бізнес, що принесе користь рідному місту і Запоріжжя та нашій країні у ці скрутні часи. На початку
          ...
          <div className="bg-bg-light-orange max-w-[468px] rounded-3xl md:absolute top-[586px] left-[10px] md:left-[300px] py-3 px-6">
            ...
            <p className="font-medium">
              ...
              бізнесу. Сьогодні наш онлайн-магазин м&apos;ясних виробів пропонує широкий вибір с делікатесів з
              м&apos;яса різного виду, що допомагає стати нам корисними всім - людям з порушенням травленням,
