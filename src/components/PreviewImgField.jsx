...
const PreviewImgField = observer(() => {
  ...
  return (imgUrl.length !== 0) &&
    <img src={imgUrl.at(-1)} alt="preview image" className={"border border-txt-main-white text-txt-main-white text-center w-[162px] h-[192px] object-contain rounded-3xl"}/>
})
