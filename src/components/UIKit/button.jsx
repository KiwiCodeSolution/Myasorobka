...
const buttonsStyle = {
  ...
  blackMedium:
    "bg-bg-black w-[240px] h-[56px] py-[14px] text-xl font-semibold text-txt-main-white border border-2 border-bg-white hover:shadow-btnBlack focus:shadow-btnBlack",
  whiteSmall:
