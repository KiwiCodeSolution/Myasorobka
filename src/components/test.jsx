  ...
  return (
    <div>
      <div className={`flex flex-col gap-y-4 ${themeStyle} w-full h-[300px]`}>
        ...
        <button className="m-auto w-fit p-4 border border-black rounded-md" type="button" onClick={() => counter.inc()}>
          increment
        </button>
        <button
          className="m-auto w-fit p-4 border border-black rounded-md"
          type="button"
